...
type CodeActionsService struct {
	...
	codeApiClient code.VulnmapCodeClient
}
...
func NewService(c *config.Config, provider ide.IssueProvider, fileWatcher dirtyFilesWatcher, notifier noti.Notifier, codeApiClient code.VulnmapCodeClient) *CodeActionsService {

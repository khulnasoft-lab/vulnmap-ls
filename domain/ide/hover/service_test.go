...
func setupFakeHover() string {
	...
	fakeHover := []Hover[Context]{
		{Range: vulnmap.Range{
			Start: vulnmap.Position{Line: 3, Character: 56},
			End:   vulnmap.Position{Line: 5, Character: 80},
		},
		},
	}
...
func Test_GetHoverMultiline(t *testing.T) {
	...
	tests := []struct {
		...
		query        vulnmap.Position
		expected     Result
	}{
		// multiline range
		{
			hoverDetails: []Hover[Context]{{Range: vulnmap.Range{
				Start: vulnmap.Position{Line: 3, Character: 56},
				End:   vulnmap.Position{Line: 5, Character: 80},
			},
				Message: "## Vulnerabilities found"}},
			query: vulnmap.Position{Line: 4, Character: 66},
		...
		{
			hoverDetails: []Hover[Context]{{Range: vulnmap.Range{
				Start: vulnmap.Position{Line: 4, Character: 56},
				End:   vulnmap.Position{Line: 4, Character: 80},
			},
				Message: "## Vulnerabilities found"}},
			query: vulnmap.Position{Line: 4, Character: 66},
			expected: Result{Contents: MarkupContent{
		...
		// exact line and exact character
		{
			hoverDetails: []Hover[Context]{{Range: vulnmap.Range{
				Start: vulnmap.Position{Line: 4, Character: 56},
				End:   vulnmap.Position{Line: 4, Character: 56},
			},
				Message: "## Vulnerabilities found"}},
			query: vulnmap.Position{Line: 4, Character: 56},
			expected: Result{Contents: MarkupContent{
				Kind: "markdown", Value: "## Vulnerabilities found"},
			},
		},
		// hover left of the character position on exact line
		{
			hoverDetails: []Hover[Context]{{Range: vulnmap.Range{
				Start: vulnmap.Position{Line: 4, Character: 56},
				End:   vulnmap.Position{Line: 4, Character: 86},
			},
				Message: "## Vulnerabilities found"}},
			query: vulnmap.Position{Line: 4, Character: 45},
			expected: Result{Contents: MarkupContent{
				Kind: "markdown", Value: ""},
			},
		},
		// hover right of the character position on exact line
		{
			hoverDetails: []Hover[Context]{{Range: vulnmap.Range{
				...
				Message: "## Vulnerabilities found"}},
			query: vulnmap.Position{Line: 4, Character: 105},
			expected: Result{Contents: MarkupContent{
				Kind: "markdown", Value: ""},
			},
		},
...
func Test_TracksAnalytics(t *testing.T) {
	...
	target.GetHover(path, vulnmap.Position{Line: 4, Character: 66})
...
func Test_SendingHovers_AfterClearAll_DoesNotBlock(t *testing.T) {
	...
	assert.Eventually(t, func() bool {
		return service.GetHover(hover.Path, vulnmap.Position{
			Line:      10,
			Character: 14,
		}).Contents.Value != ""

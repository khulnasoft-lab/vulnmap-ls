...
func (s *DefaultHoverService) isHoverForPosition(hover Hover[Context], pos vulnmap.Position) bool {
	hoverRange := hover.Range
	posRange := vulnmap.Range{Start: pos, End: pos}
...
func (s *DefaultHoverService) trackHoverDetails(hover Hover[Context]) {
	...
	case vulnmap.Issue:
		issue := hover.Context.(vulnmap.Issue)

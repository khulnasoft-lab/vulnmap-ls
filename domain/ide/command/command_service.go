...
var instance vulnmap.CommandService
...
func (service *serviceImpl) ExecuteCommandData(ctx context.Context, commandData vulnmap.CommandData, server lsp.Server) (any, error) {
	log.Debug().Str(
		"method",

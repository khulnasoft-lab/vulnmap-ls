...
func Test_openLearnLesson_Execute(t *testing.T) {
	...
	data := vulnmap.CommandData{
		Title:     vulnmap.OpenLearnLesson,
		CommandId: vulnmap.OpenLearnLesson,
	...
	mockService.EXPECT().
		GetLesson(eco, rule, []string{"CWE-89", "CWE-ZZ"}, []string{"CVE-2020-1234"}, vulnmap.DependencyVulnerability).

...
const (
	Advisor              AnalysisType = "Vulnmap Advisor"
	CodeQuality          AnalysisType = "Vulnmap Code Quality"
	CodeSecurity         AnalysisType = "Vulnmap Code Security"
	OpenSource           AnalysisType = "Vulnmap Open Source"
	Container            AnalysisType = "Vulnmap Container"
	InfrastructureAsCode AnalysisType = "Vulnmap Infrastructure as Code"
)

...
// Source: github.com/khulnasoft-lab/vulnmap-ls/infrastructure/learn (interfaces: Service)
...
func (m *MockService) GetLesson(arg0, arg1 string, arg2, arg3 []string, arg4 vulnmap.Type) (*learn.Lesson, error) {
	m.ctrl.T.Helper()

...
func (c VulnmapCli) Execute(ctx context.Context, cmd []string, workingDir string) (resp []byte, err error) {
...
func (c VulnmapCli) getCommand(cmd []string, workingDir string, ctx context.Context) *exec.Cmd {

...
// Runtime: go-ampli
//
// View Tracking Plan: https://data.amplitude.com/vulnmap/Vulnmap/events/main/latest
//
// Full Setup Instructions: https://data.amplitude.com/vulnmap/Vulnmap/implementation/main/latest/getting-started/language-server
//
...
type IdentifyBuilder interface {
	...
	IsVulnmap(isVulnmap bool) IdentifyBuilder
	IsVulnmapAdmin(isVulnmapAdmin bool) IdentifyBuilder
...
func (b *identifyBuilder) IsVulnmap(isVulnmap bool) IdentifyBuilder {
	b.properties[`isVulnmap`] = isVulnmap

	return b
}

func (b *identifyBuilder) IsVulnmapAdmin(isVulnmapAdmin bool) IdentifyBuilder {
	b.properties[`isVulnmapAdmin`] = isVulnmapAdmin
...
var AnalysisIsReady = struct {
	AnalysisType struct {
		VulnmapAdvisor AnalysisIsReadyAnalysisType

		VulnmapCodeQuality AnalysisIsReadyAnalysisType

		VulnmapCodeSecurity AnalysisIsReadyAnalysisType

		VulnmapOpenSource AnalysisIsReadyAnalysisType

		VulnmapContainer AnalysisIsReadyAnalysisType

		VulnmapInfrastructureAsCode AnalysisIsReadyAnalysisType
	}
	Ide struct {
	...
	AnalysisType: struct {
		...
		VulnmapAdvisor: `Vulnmap Advisor`,

		VulnmapCodeQuality: `Vulnmap Code Quality`,

		VulnmapCodeSecurity: `Vulnmap Code Security`,

		VulnmapOpenSource: `Vulnmap Open Source`,

		VulnmapContainer: `Vulnmap Container`,

		VulnmapInfrastructureAsCode: `Vulnmap Infrastructure as Code`,
	},
	Ide: struct {
		VisualStudioCode AnalysisIsReadyIde
